...
const broker = 'mqtts://frequency:Frequency2026@733a68acf9ac4fce9c79fc4e118744b5.s1.eu.hivemq.cloud:8883'; 
...
client.on('connect', () => {
  ...
  const displayTopic = `freq.led/courts/${courtId}/display`;
...
client.on('message', (topic, message) => {
  if (topic === `freq.led/courts/${courtId}/display`) {

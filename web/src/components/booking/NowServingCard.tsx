...
export function NowServingCard({ playerNames, courtName, duration, expiresAt }: Props) {
  ...
  return (
    <div className="bg-[#20362a] rounded-lg p-4 border border-[#32A45E]/35">
      <p className="text-xs font-medium text-[#72d493] uppercase tracking-wider mb-1">Now Serving</p>
      ...
      <p className={`text-3xl font-mono font-bold tabular-nums ${isUrgent ? 'text-red-400' : 'text-[#72d493]'}`}>

  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 gap-5 text-center animate-fade-in bg-[#18261f]">
      ...
      <div className={`size-16 rounded-full border flex items-center justify-center transition-all duration-550 scale-100 animate-pulse-subtle ${
        isConfirmed 
          ? 'bg-[#32A45E]/15 border-[#32A45E]/40 shadow-[0_0_20px_rgba(50,164,94,0.15)] text-[#72d493]'
          : 'bg-[#d9a441]/15 border-[#d9a441]/40 shadow-[0_0_20px_rgba(217,164,65,0.1)] text-[#e2b85a]'
      }`}>
        {isConfirmed ? (
      ...
      <div className="bg-[#1b2a23] border border-[#2b4035] rounded-2xl p-4.5 w-full max-w-xs shadow-md shadow-black/10 space-y-2.5">
        ...
        <div className="flex justify-between items-center text-xs">
          ...
          <span className="font-bold text-[#72d493]">₱{creditsRemaining.toLocaleString()}</span>
        </div>
      </div>

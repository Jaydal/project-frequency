...
lv_obj_t *step_select_court_create(lv_obj_t *parent,
  ...
  lv_obj_t *stepper = booking_stepper_create(root, 0, member_name, balance, on_cancel, cancel_user_data);
  ...
  kiosk_theme_pin_pressed(any_tile);

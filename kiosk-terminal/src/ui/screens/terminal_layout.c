...
terminal_layout_t terminal_layout_create(lv_obj_t *parent) {
  ...
  lv_obj_set_size(layout.root, 1024, 600);
  ...
  lv_obj_clear_flag(layout.root, LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_SCROLL_ELASTIC | LV_OBJ_FLAG_SCROLL_MOMENTUM | LV_OBJ_FLAG_SCROLL_ON_FOCUS);
  lv_obj_set_scrollbar_mode(layout.root, LV_SCROLLBAR_MODE_OFF);

  /* 2. Main content area - takes remaining width, fixed 600 height, solid opaque background */
  layout.content = lv_obj_create(layout.root);
  lv_obj_remove_style_all(layout.content);
  lv_obj_set_height(layout.content, 600);
  ...
  lv_obj_clear_flag(layout.content, LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_SCROLL_ELASTIC | LV_OBJ_FLAG_SCROLL_MOMENTUM | LV_OBJ_FLAG_SCROLL_ON_FOCUS);
  ...
  lv_obj_clear_flag(layout.sidebar, LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_SCROLL_ELASTIC | LV_OBJ_FLAG_SCROLL_MOMENTUM | LV_OBJ_FLAG_SCROLL_ON_FOCUS);
  lv_obj_set_scrollbar_mode(layout.sidebar, LV_SCROLLBAR_MODE_OFF);
